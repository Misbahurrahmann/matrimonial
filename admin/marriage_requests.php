...
$query="select * from tbl_mrequest";
$res=mysql_query($query);
//header("location:edit_profile.php");
?>
<html>
<head>
<link href="css/marriage_requests.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<center>
<div id="outer">
...
<td><a href="delete_marriage_reqests.php?id=<?php echo $row['request_id']?>">delete</a></td>
</tr>
<?php
$i++;
}
